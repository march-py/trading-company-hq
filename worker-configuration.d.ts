/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=dev` (hash: cbf1cd13aba8c6da12328e4f7496ea3f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_NAME">> {}
}
